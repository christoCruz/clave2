...
/**
 *
 * @author Chritopher Lysander Cruz Martinez
 * CM17066
 */
public abstract class rungakutta {
    ...
    public  void calcular(float h,float xi,float xf,float y1) throws IOException{
        ...
        ps=Ks.toString();
        ls=Xs.toString();
        File fichero=new File("ecuacion.txt");
    ...
    File objetofile=new File(archivo);
        try {
            ...
            Logger.getLogger(rungakutta.class.getName()).log(Level.SEVERE, null, ex);
        }
